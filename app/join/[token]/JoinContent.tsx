        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          {status === 'success' && (
            <>
              ...
              <Link href="/dashboard" className="inline-block w-full py-3 text-sm font-semibold text-white bg-primary-600 rounded-xl hover:bg-primary-700 transition-colors">
                Go to My Dashboard
              </Link>
            </>
          )}
          ...
          {status === 'auth_required' && (
            <>
              ...
              <div className="space-y-3">
                <Link href={`/login?redirect=/join/${token}`} className="block w-full py-3 text-sm font-semibold text-white bg-primary-600 rounded-xl hover:bg-primary-700 transition-colors">
                  Sign in
                </Link>
                <Link href={`/register?redirect=/join/${token}`} className="block w-full py-3 text-sm font-semibold text-primary-700 bg-primary-50 border border-primary-200 rounded-xl hover:bg-primary-100 transition-colors">
                  Create an account
                </Link>
              </div>
            </>
          ...
          {status === 'error' && (
            <>
              ...
              <Link href="/dashboard" className="inline-block w-full py-3 text-sm font-semibold text-slate-700 bg-slate-100 rounded-xl hover:bg-slate-200 transition-colors">
                Go to Dashboard
              </Link>
            </>
          )}
